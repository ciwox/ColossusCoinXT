...
void CWallet::ZPivBackupWallet()
{
    ...
    for (int i = 0; i < 10; i++) {
        strNewBackupName = strprintf("wallet-autozcolxbackup-%d.dat", i);
        ...
        if (filesystem::exists(backupPath)) {
            ...
            if (i <= 8) {
                ...
                filesystem::path nextBackupPath = backupDir / strprintf("wallet-autozcolxbackup-%d.dat", i + 1);
            ...
            strNewBackupName = strprintf("wallet-autozcolxbackup-%d.dat", 0);
            backupPath = backupDir / strNewBackupName;
            break;
        }
